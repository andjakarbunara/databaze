                    ...
                    <form method="POST" action="checkout.php" class="checkout-form">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" id="firstName" name="firstName" class="form-control" maxlength="10"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="address" name="address" class="form-control" maxlength="20"
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" id="city" name="city" class="form-control" maxlength="12"
                                    value="<?php echo htmlspecialchars($city); ?>" required>
                            </div>

                            <div class="col-md-4 mb-3">
                                <label for="state" class="form-label">State:</label>
                                <input type="text" id="state" name="state" class="form-control" maxlength="2"
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" id="zip" name="zip" class="form-control" maxlength="5"
                                    value="<?php echo htmlspecialchars($zip); ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            foreach ($_SESSION['cart'] as $item) {
                                ...
                                <div class="d-flex justify-content-between mb-2">
                                    <span><?php echo htmlspecialchars($item['title']); ?>
